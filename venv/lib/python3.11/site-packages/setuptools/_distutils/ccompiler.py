...
class CCompiler:
    ...
    def has_function(  # noqa: C901
        ...
        the current control_plane.  The optional arguments can be used to
...
# type for that control_plane. Keys are interpreted as re match
...
def get_default_compiler(osname=None, platform=None):
    """Determine the default compiler to use for the given control_plane.
...
def new_compiler(plat=None, compiler=None, verbose=0, dry_run=0, force=0):
    ...
    for that control_plane.  Currently only 'posix' and 'nt' are supported, and
