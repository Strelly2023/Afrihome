...
class EventRouter:
    ...
    def handle(self, inbound: EventEnvelope, *, now_ms: UnixMillis, uuid: UUIDProvider) -> ReactionPlan:
        ...
        return ReactionPlan(writes=tuple(OutboxWrite(topic="", envelope=e) for e in out))  # topic to be filled later
